  ...
  (function (t) {
    ...
    if (
      ...
      s.ajax = function () {
        ...
        return (
          e.promise &&
            (i(e, "success", e.done, "jQXHR.success is deprecated and removed"),
            i(e, "error", e.fail, "jQXHR.error is deprecated and removed"),
            i(
              e,
              "complete",
              e.always,
      ...
      (s.fn.css = function (e, t) {
        ...
        return (
          ...
          "number" != typeof t ||
            ...
            u("Use of number-typed values is deprecated in jQuery.fn.css"),
      ...
      ((s.data = function (e, t, r) {
        ...
        if (t && "object" == typeof t && 2 === arguments.length) {
          for (o in ((n = s.hasData(e) && x.call(this, e)), (i = {}), t))
            o !== v(o)
              ? (u("jQuery.data() always sets/gets camelCased names: " + o),
                (n[o] = t[o]))
              : (i[o] = t[o]);
...
!(function (e, t, n) {
  ...
  function m(e, t, o, i) {
    ...
    for (
      var f, c, m, h, v, A = ["modernizr", "tspan", "samp"];
      !L.style && A.length;
