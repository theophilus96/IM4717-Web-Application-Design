...
//html code
    ...
    echo '</style>';
    echo '<script type="text/javascript" src="../script/productprice.js"></script>';
    echo '</head>';
    echo '<body>';
    echo '<div id="wrapper">';
    echo '<header>';
    ...
    echo "<input type=\"checkbox\" id=\"checkbox1\" name=\"checkbox1\" onChange=\"this.form.submit()\">\n";
    echo "</td>";
    echo '<th>';
    ...
    echo '<tr>';
    echo "<td bgcolor=\"#fcebb6\">\n";
    echo "<input type=\"checkbox\" id=\"checkbox2\" name=\"checkbox2\" onChange=\"this.form.submit()\">\n";
    echo "</td>";
    ...
    echo '<tr>';
    echo "<td bgcolor=\"#fcebb6\">\n";
    echo "<input type=\"checkbox\" id=\"checkbox3\" name=\"checkbox3\" onChange=\"this.form.submit()\">\n";
    echo "</td>";
